...
function Library:Window(Options)
    ...
    HolderOutline.Position = UDim2.new(0, 6, 0, 6)
    HolderOutline.Size = UDim2.new(1, -12, 1, -23)  
    ...
    PageOutline.Position = UDim2.new(0, 4, 0, 18)
    PageOutline.Size = UDim2.new(1, -8, 1, -22)  
    ...
    Window.Elements = {
		...
		function Library:Page(Properties)
			...
			NewButton.Size = UDim2.new(0, Page.Window.PageAmount and ((((Page.Window.Elements.Base.Size.X.Offset - 35) - ((Page.Window.PageAmount - 3) * 2)) / Page.Window.PageAmount)) - 3 or Page.Size, 1, 0);
			...
			function Page:Turn(bool)
				...
				ButtonInline.BackgroundColor3 = Page.Open and Color3.fromRGB(20, 20, 20) or Color3.fromRGB(20, 20, 20)
				...
				Line.BackgroundColor3 = Page.Open and Color3.fromRGB(20, 20, 20) or Color3.fromRGB(20, 20, 20)
